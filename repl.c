...
#define LASSERT_TYPE(syms, args, index, LVAL_QEXPR) \
    LASSERT(args, args->cell[index]->type == LVAL_QEXPR, \
    "Function '%s' passed incorrect argument type. Got %i, Expected %i.", syms, args->cell[index]->type, LVAL_QEXPR);
